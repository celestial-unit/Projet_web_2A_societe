...
$normalclasses = $formationController->getnormalclassesFormations();
?>
<!DOCTYPE html>
<html lang="en" >
<head>
...
<body>
<?php foreach ($normalclasses as $formationn) { ?>
...
<!-- partial -->
<script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js'></script><script  src="./perfect.js"></script>
</body>
</html>
<?php
