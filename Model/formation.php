<?php 
    class formation{
       ...
       private ?string $email= null;
        ...
        public function __construct($id_typeformation, $Nom,$ispaid,$niveau,$image_url,$nbheures,$type_cours,$nature_cours,$datedebut,$domaine,$id_formation,$location,$email)
        {
