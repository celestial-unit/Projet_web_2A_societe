...
<div class="container">
        ...
        <div class="main">
            ...
            <div class="details">
              ...
              <?php 
                if (isset($_GET['id'])){
                  $foru = $forumC->recupererForum($_GET['id']);
              ?> 
              <form method="POST" onsubmit="return verif();">
                        <div class="row mb-3">
                          <div class="col-sm-10">
                            <input type="text" class="form-control p-2" value="<?php echo $foru['titre']?>" name="titre" id="titre" placeholder="Titre">
                          </div>
                        </div>
                        <br>
                        <div class="row mb-3">
                          <div class="col-sm-10">
                            <input type="date" class="form-control p-2" value="<?php echo $foru['date']?>" name="date" id="date" placeholder="Date">
                          </div>
                        </div>
                        <br>
                        <div class="row mb-3">
                          <div class="col-sm-10">
                            <textarea type="text" class="form-control p-2" name="description" id="description" placeholder="Description"><?php echo $foru['description']?></textarea>
                          </div>
                        </div>
                        <br>
                        <div class="row mb-3">
                          <div class="col-sm-10">
                            <input type="text" class="form-control p-2" value="<?php echo $foru['etat']?>" name="etat" id="etat" placeholder="Etat">
                          </div>
                        </div>
                        <br>
