...
$currentDate = date('Y-m-d');
   ...
   if(isset($_POST['ajout']))
	{
    	header ('Location:afficherForumFront.php');
	}
      ...
      <div class="row">
        <div class="carousel slide">
                        <form method="POST" onsubmit="return verif();">
                            <div class="row mb-3">
                              <div class="col-sm-10">
                                <textarea type="text" class="form-control p-2" name="contenu" id="contenu" placeholder="Contenu"></textarea>
                              </div>
                            </div>
                            <br>
                            <div class="text-center">
                              <input class="btn btn-primary" type="submit" name="ajout" value="Commenter">
                            </div>
