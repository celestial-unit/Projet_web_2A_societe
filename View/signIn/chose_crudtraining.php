...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <!-- ======================= Cards ================== -->
            <div class="cardBox">
    <button class="card" onclick="window.location.href='../crudtypeformation.php'">
        <div>
            <div class="numbers">Manage type of trainings</div>
            <div class="cardName"></div>
        </div>
        
    </button>

    <button class="card" onclick="window.location.href='../newcrudview.php'">
        <div>
            <div class="numbers">Manage trainings</div>
            <div class="cardName"></div>
        </div>
