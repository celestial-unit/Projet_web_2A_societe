...
<body>
    <div class="delete-form">
        <h2>Disable User</h2>
        <form id="deleteUserForm" method='get' action='get_disableuser_by_admin.php'>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#disable").on("click", function () {
                ...
                var emailToDisable = $("#email").val();
                
                // Utilisez AJAX pour appeler le script PHP
                $.ajax({
                    url: 'get_disableuser_by_admin.php',
                    type: 'GET',
                    data: { email: emailToDisable },
