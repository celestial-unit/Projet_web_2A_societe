...
<body>
    <div class="delete-form">
        <h2>Delete User</h2>
        <form id="deleteUserForm" method='get' action='get_deleteduser_by_admin.php'>
...
<script>
    $(document).ready(function () {
            // Ajoutez un gestionnaire d'événements de clic au bouton Delete
            $("#delete").on("click", function () {
                ...
                $.ajax({
                    url: 'get_deleteduser_by_admin.php',
                    type: 'GET',
