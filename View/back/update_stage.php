...
include 'C:\wamp64\www\Stage\controler\stage.php';
include 'C:\wamp64\www\Stage\model\Stage.php';
$error = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($updateTypeStageSQL) === TRUE) {
        echo "Type_stage updated successfully";
    } else {
        echo "Error updating type_stage: " . $conn->error;
    }
}
